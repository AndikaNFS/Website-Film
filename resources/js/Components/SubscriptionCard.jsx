...
export default function SubscriptionCard ({id, name, price, durationInMouth, features, isPremium, onSelectSubscription }) {
    return (
        <>
            {/* <!-- Basic --> */}
            {!isPremium && (
                ...
                <div>
                    ...
                    <p class="text-gray-1 text-xs font-light">/{durationInMouth} months</p>
                </div>

                {/* <!-- Mid Content: Benefits --> */}
                <div class="flex flex-col gap-4">
                    {features.map((feature, index) => (
                        <div class="flex items-center gap-2" key={`${index}-${id}-${feature}`}>
            ...
            {isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-white w-[300px] bg-black">
                            ...
                            <div>
                                ...
                                <p className="text-[#767676] text-xs fontLight">/{durationInMouth} months</p>
                            </div>
